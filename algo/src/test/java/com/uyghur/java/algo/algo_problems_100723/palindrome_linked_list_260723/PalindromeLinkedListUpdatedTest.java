...
class PalindromeLinkedListUpdatedTest {

    @InjectMocks
    private PalindromeLinkedListUpdated palindromeLinkedListUpdated;

    @Test
    void checkPalindromeWithOddNodeNumber() {
        ListNode listNode = ListNode.of(1, 2, 2, 2, 1);
        assertThat(palindromeLinkedListUpdated.isPalindrome(listNode)).isTrue();
    }
    ...
    void checkPalindromeWithEvenNodeNumberShouldReturnFalse() {
        ...
        assertThat(palindromeLinkedListUpdated.isPalindrome(listNode)).isFalse();
    }
